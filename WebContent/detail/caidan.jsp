...
<body style="text-align: center">
	<div id="all">
				...
				<ul>
					...
					<c:forEach var="list" items="${requestScope.foodList.data }">
						<li>
							<dl>
								<dt>
									<a href="${pageContext.request.contextPath }/detail/caixiangxi.jsp?foodId=${pageScope.list.FOODID }&foodName=${pageScope.list.FOODNAME }&price=${pageScope.list.PRICE }&imagePath=${pageScope.list.IMAGEPATH }&introduce=${pageScope.list.INTRODUCE }">
										<img width="214px" height="145px" src="${pageContext.request.contextPath }/showImage?imageName=${pageScope.list.IMAGEPATH}" />
									</a>
								</dt>
								<dd class="f1">
									<a href="${pageContext.request.contextPath }/detail/caixiangxi.jsp?foodId=${pageScope.list.FOODID }&foodName=${pageScope.list.FOODNAME }&price=${pageScope.list.PRICE }&imagePath=${pageScope.list.IMAGEPATH }&introduce=${pageScope.list.INTRODUCE }">${pageScope.list.FOODNAME }</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath }/detail/caixiangxi.jsp?foodId=${pageScope.list.FOODID }&foodName=${pageScope.list.FOODNAME }&price=${pageScope.list.PRICE }&imagePath=${pageScope.list.IMAGEPATH }&introduce=${pageScope.list.INTRODUCE }">&yen;${pageScope.list.PRICE }</a>
								</dd>
							</dl>
						</li>
					</c:forEach>
					...
					<ul>
						...
						<li>
							<c:forEach var="i" begin="1" end="${requestScope.foodList.totalPage}" step="1">
								<a href="${pageContext.request.contextPath}/showCuisine?curPage=${pageScope.i}">${pageScope.i}</a>
							</c:forEach>
						</li>
		...
		<div id="dish_class">
			...
			<div id="dish_3">
				<!-- 搜索菜品表单  -->
				<form action="${pageContext.request.contextPath }/showCuisine" method="post">
					<table width="166px">
						<tr>
							<td>
